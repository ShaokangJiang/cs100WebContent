    ...
    try{  
         if(request.getParameter("errNo")!=null)  
          ...
          if(request.getParameter("login")!=null)  
         	h = "Sign up successfully, we send an email to your account just now, please follow the link in that email to finish register.";
    }catch(Exception e){
        e.printStackTrace();
    }  
    Date now = new Date(); 
   ...
   %>  
    ...
    <form action = "loginCh.jsp" method = "post" onsubmit = "return validate()">  
        ...
        <div class="col s10 m8 l4">
          <div class="card white z-depth-3">
            <div class="card-content black-text">
              ...
              <a class="black-text">Want to use email to login?</a>
              <a href="login2.jsp">Click here</a><br>
              <a class="black-text">Don't have an account?</a>
              <a href="register.jsp">Sign up now!</a><br>
      ...
      <div class="input-field col s12">
          ...
          <input id="loginName" class="validate" type="text" name="name" value="" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"> 
