...
<html>  
  ...
  <body>  
    <%      
            ...
            PreparedStatement pStmt1 = conn.prepareStatement("select * from dbo.login where Name = '" + user + "'");  
            ResultSet rs1 = pStmt1.executeQuery();
            if(rs1.next()){
            PreparedStatement pStmt = conn.prepareStatement("select * from dbo.login where Name = '" + user + "' and Password = '" + pwd + "'");  
